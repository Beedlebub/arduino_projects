...
//char pass[] = "Eyel0veNYC";    // your network password (use for WPA, or use as key for WEP)


#ifndef STASSID
#define STASSID "ORBI11"
#define STAPSK  "Eyel0veNYC"
#endif
...
int        port        = 1883;
const char willTopic[] = "esp8266/will";
